...
VALUES
('a1111111-1111-1111-1111-111111111111', 'West End Pharmacy', 'west-end-pharmacy', 'westend@nextdoorclinic.co.uk', '+442079460912', '142 Oxford Street, London, W1D 1NB', 'London', 'W1D 1NB', 'APPROVED', '1038492', 'FA912', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'West End Healthcare & Travel Clinic', 'Premier central London pharmacy providing travel vaccines, ear wax removal, and NHS Pharmacy First services.', true, true, 'Outstanding', 'PHARMACY', NOW(), NOW()),
('a2222222-2222-2222-2222-222222222222', 'Central Health Pharmacy', 'central-health-pharmacy', 'central@nextdoorclinic.co.uk', '+441614960182', '58 Deansgate, Manchester, M3 2BW', 'Manchester', 'M3 2BW', 'APPROVED', '1094820', 'FM820', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Central Health Pharmacy Manchester', 'Full-service clinical pharmacy located in the heart of Manchester city center.', true, true, 'Good', 'PHARMACY', NOW(), NOW()),
('a3333333-3333-3333-3333-333333333333', 'St Jude Pharmacy', 'st-jude-pharmacy', 'stjude@nextdoorclinic.co.uk', '+441214960293', '24 New Street, Birmingham, B2 4BF', 'Birmingham', 'B2 4BF', 'APPROVED', '1058291', 'FB291', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'St Jude Pharmacy & Clinic', 'Verified GPhC clinical hub in Birmingham providing blood tests, consultations, and immunizations.', true, true, 'Good', 'PHARMACY', NOW(), NOW()),
('a4444444-4444-4444-4444-444444444444', 'Riverfront Pharmacy', 'riverfront-pharmacy', 'riverfront@nextdoorclinic.co.uk', '+441134960812', '12 Briggate, Leeds, LS1 6ER', 'Leeds', 'LS1 6ER', 'APPROVED', '1073918', 'FL812', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Riverfront Pharmacy Leeds', 'Independent community pharmacy and private health clinic serving Leeds.', true, true, 'Good', 'PHARMACY', NOW(), NOW()),
('a5555555-5555-5555-5555-555555555555', 'Northside Health', 'northside-health', 'northside@nextdoorclinic.co.uk', '+441414960412', '89 Buchanan Street, Glasgow, G1 3HF', 'Glasgow', 'G1 3HF', 'APPROVED', '1029481', 'FG412', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Northside Health Glasgow', 'Top-rated healthcare provider in Glasgow specializing in travel vaccinations & wellness checks.', true, true, 'Good', 'CLINIC', NOW(), NOW())
...
VALUES ('f1111111-1111-1111-1111-111111111111', 'admin@nextdoorclinic.co.uk', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Super Admin', NOW(), NOW())
